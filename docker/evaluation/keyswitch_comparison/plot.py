...
# ---------------------------------------------------------------------------
# Configuration labels and file names
# The runscript writes one log file per configuration named
# <config_label>.log inside results_dir.
# ---------------------------------------------------------------------------
CONFIGS = [
...
ax.set_ylabel("Keyswitch latency (ms)", fontsize=12)
ax.set_title("Keyswitch Latency Comparison", fontsize=14)
ax.set_xticks(x)
